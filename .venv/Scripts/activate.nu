...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\User\PycharmProjects\pythonProject\PythonBasics cources\.venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\User\PycharmProjects\pythonProject\PythonBasics cources\.venv\Scripts\deactivate.nu'
